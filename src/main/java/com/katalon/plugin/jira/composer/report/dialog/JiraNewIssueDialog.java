...
public class JiraNewIssueDialog extends JiraIssueBrowserDialog {
    private Logger logger = (Logger) LoggerFactory.getLogger(JiraNewIssueDialog.class);

    private final DefaultIssueHTMLLinkProvider htmlLinkProvider;

    public JiraNewIssueDialog(Shell parentShell, TestCaseRecord logRecord, DefaultIssueHTMLLinkProvider htmlLinkProvider)
