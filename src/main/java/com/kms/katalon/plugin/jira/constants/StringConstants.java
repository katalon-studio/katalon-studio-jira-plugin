...
public class StringConstants {
    ...
    public static final String JIRA_PLUGIN_BUNDLE_ID = "com.katalon.katalon-studio-jira-plugin";
    ...
    public static final String PREF_LAST_EDITED_JIRA_JQL = "lastEditedJiraJQL";
    ...
    public static final String DF_ISSUE_TYPE_NAME = "Bug";

    public static final String HREF_BROWSE_ISSUE = "/browse";
